...
//******************************************************************************
/* Function :  ADCHS_ChannelSetup_PIC32MZ_DA

  Summary:
    Implements PIC32MZ_DA variant of PLIB_ADCHS_ChannelSetup 

  Description:
    This template implements the PIC32MZ_DA variant of the PLIB_ADCHS_ChannelSetup function.
    Operation is not atomic.
*/

PLIB_TEMPLATE void ADCHS_ChannelSetup_PIC32MZ_DA( ADCHS_MODULE_ID index , ADCHS_CHANNEL_ID channelID , ADCHS_DATA_RESOLUTION res , uint8_t	channelClockDivider , uint16_t sampleTimeCount , ADCHS_EARLY_INTERRUPT_PRIOR_CLOCK earlyInterruptClk )
{
    volatile adchs_register_t *regs = (adchs_register_t *)index;
...
//******************************************************************************
/* Function :  ADCHS_ExistsConfiguration_PIC32MZ_DA

  Summary:
    Implements PIC32MZ_DA variant of PLIB_ADCHS_ExistsConfiguration

  Description:
    This template implements the PIC32MZ_DA variant of the PLIB_ADCHS_ExistsConfiguration function.
*/

#define PLIB_ADCHS_ExistsConfiguration PLIB_ADCHS_ExistsConfiguration
PLIB_TEMPLATE bool ADCHS_ExistsConfiguration_PIC32MZ_DA( ADCHS_MODULE_ID index )
{
    return true;
}


#endif /*_ADCHS_SETUP_PIC32MZ_DA_H*/
