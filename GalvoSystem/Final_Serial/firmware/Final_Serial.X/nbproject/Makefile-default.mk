...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Final_Serial.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Final_Serial.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/_ext/1534029872/app.o: /Applications/microchip/harmony/v2_06/apps/Final_Serial/firmware/src/app.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1534029872" 
	@${RM} ${OBJECTDIR}/_ext/1534029872/app.o.d 
	@${RM} ${OBJECTDIR}/_ext/1534029872/app.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1534029872/app.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -DPKOBSKDEPlatformTool=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -O1 -I"../src" -I"../src/system_config/default" -I"../src/default" -I"../../../../framework" -I"../src/system_config/default/framework" -I"../../../../../../../../../Applications/microchip/harmony/v2_06/framework" -I"../src/system_config/default/bsp" -MMD -MF "${OBJECTDIR}/_ext/1534029872/app.o.d" -o ${OBJECTDIR}/_ext/1534029872/app.o /Applications/microchip/harmony/v2_06/apps/Final_Serial/firmware/src/app.c    -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD) 
	
${OBJECTDIR}/_ext/1534029872/main.o: /Applications/microchip/harmony/v2_06/apps/Final_Serial/firmware/src/main.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1534029872" 
	@${RM} ${OBJECTDIR}/_ext/1534029872/main.o.d 
	@${RM} ${OBJECTDIR}/_ext/1534029872/main.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1534029872/main.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -DPKOBSKDEPlatformTool=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -O1 -I"../src" -I"../src/system_config/default" -I"../src/default" -I"../../../../framework" -I"../src/system_config/default/framework" -I"../../../../../../../../../Applications/microchip/harmony/v2_06/framework" -I"../src/system_config/default/bsp" -MMD -MF "${OBJECTDIR}/_ext/1534029872/main.o.d" -o ${OBJECTDIR}/_ext/1534029872/main.o /Applications/microchip/harmony/v2_06/apps/Final_Serial/firmware/src/main.c    -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/_ext/1534029872/app.o: /Applications/microchip/harmony/v2_06/apps/Final_Serial/firmware/src/app.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1534029872/app.o.d 
	@${RM} ${OBJECTDIR}/_ext/1534029872/app.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1534029872/app.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -O1 -I"../src" -I"../src/system_config/default" -I"../src/default" -I"../../../../framework" -I"../src/system_config/default/framework" -I"../../../../../../../../../Applications/microchip/harmony/v2_06/framework" -I"../src/system_config/default/bsp" -MMD -MF "${OBJECTDIR}/_ext/1534029872/app.o.d" -o ${OBJECTDIR}/_ext/1534029872/app.o /Applications/microchip/harmony/v2_06/apps/Final_Serial/firmware/src/app.c    -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD) 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/Final_Serial.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  ../../../../../../../../../Applications/microchip/harmony/v2_06/bin/framework/peripheral/PIC32MZ2064DAG169_peripherals.a  
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -g -mdebugger -DPKOBSKDEPlatformTool=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Final_Serial.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}    ../../../../../../../../../Applications/microchip/harmony/v2_06/bin/framework/peripheral/PIC32MZ2064DAG169_peripherals.a      -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)   -mreserve=data@0x0:0x27F   -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,-D=__DEBUG_D,--defsym=PKOBSKDEPlatformTool=1,--defsym=_min_heap_size=0,--gc-sections,--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/Final_Serial.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  ../../../../../../../../../Applications/microchip/harmony/v2_06/bin/framework/peripheral/PIC32MZ2064DAG169_peripherals.a 
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Final_Serial.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}    ../../../../../../../../../Applications/microchip/harmony/v2_06/bin/framework/peripheral/PIC32MZ2064DAG169_peripherals.a      -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=_min_heap_size=0,--gc-sections,--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml
	${MP_CC_DIR}/xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/Final_Serial.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
