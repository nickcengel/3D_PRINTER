...
SYS_MODULE_OBJ DRV_SPI0_Initialize(void)
{
    ...
    /* Baud rate selection */
    PLIB_SPI_BaudRateSet( SPI_ID_2 , SYS_CLK_PeripheralFrequencyGet(CLK_BUS_PERIPHERAL_2), 12500000 );
    ...
    qInitData.maxElements = 16; //Queue size
...
SYS_MODULE_OBJ DRV_SPI1_Initialize(void)
{
    ...
    /* Baud rate selection */
    PLIB_SPI_BaudRateSet( SPI_ID_6 , SYS_CLK_PeripheralFrequencyGet(CLK_BUS_PERIPHERAL_2), 12500000 );
