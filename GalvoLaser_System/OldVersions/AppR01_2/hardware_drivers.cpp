...
uint8_t Axis::get_axisNumber(){
    return axisNumber;
}

void Axis::set_axisNumber(uint8_t n){
    axisNumber = n;
}
...
uint8_t Laser::get_axisNumber(){
    return axisNumber;
}

void Laser::set_axisNumber(uint8_t n){
    axisNumber = n;
}

uint8_t Device::get_deviceNumber(){
    return  deviceNumber;
}
void Device::set_deviceNumber(uint8_t n){
    deviceNumber = n;
}
...
float Material_Delivery_Device::get_speed(){
    return speed;
}
...
void Material_Delivery_Device::set_speed(float v){
    speed = v;
...
float Laser_Galvo_Device::get_speed(){
    return speed;
}
...
void Laser_Galvo_Device::set_speed(float v){
    speed = v;
...
void Laser_Galvo_Device::set_power(float p){
    laser.power = p;
