...
struct axis_settings_t
{
    ...
    float uStepPerMM;
    axis_settings_t() {}
    axis_settings_t(int aPortNumber, DEVICE_NUMBER aDeviceNumber, AXIS_NUMBER anAxisNumber,
...
{
public:
    AXIS_NUMBER get_axisNumber();
    void set_axisNumber(AXIS_NUMBER n);
    float get_position();
    bool is_homed();
...
{
public:
    DEVICE_NUMBER get_deviceNumber();
    void set_deviceNumber(DEVICE_NUMBER n);
