...
#include "../SerialSandBox/messagemanager.h"
...
QT_MOC_LITERAL(3, 27, 7) // "request"
    ...
    "MessageManager\0newMessage\0\0request"
};
...
void MessageManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MessageManager::newMessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MessageManager::newMessage(const QString & _t1)
{
