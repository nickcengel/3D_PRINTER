...
QT_MOC_LITERAL(3, 23, 10), // "LG_Package"
QT_MOC_LITERAL(4, 34, 15), // "responsePackage"
QT_MOC_LITERAL(5, 50, 5), // "error"
QT_MOC_LITERAL(6, 56, 1), // "s"
QT_MOC_LITERAL(7, 58, 7) // "timeout"

    },
    "SerialThread\0response\0\0LG_Package\0"
    "responsePackage\0error\0s\0timeout"
};
...
void SerialThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->response((*reinterpret_cast< const LG_Package(*)>(_a[1]))); break;
        ...
        {
            using _t = void (SerialThread::*)(const LG_Package );
...
// SIGNAL 0
void SerialThread::response(const LG_Package _t1)
{
