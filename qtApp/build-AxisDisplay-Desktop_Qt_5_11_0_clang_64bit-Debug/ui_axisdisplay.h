...
public:
    ...
    void setupUi(QWidget *AxisDisplay)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/icons/icons/arrowUp.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/icons/icons/arrowDown.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/icons/icons/Home.svg"), QSize(), QIcon::Normal, QIcon::Off);
